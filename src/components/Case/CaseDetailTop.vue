          ...
          <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 text_btn">
                <router-link :to="{path:'/DesignerDetail',query:{designer_id:topInfo.id}}" class="btn btn-default"
                             :id="topInfo.designer_id">去TA主页
                </router-link>
              </div>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    data: function () {
      return {
        id:this.$route.query && this.$route.query.case_id,
        collectType_id:4,
        isShow: true,
        topInfo: []
      }
