<template>
  <ul class="nav navbar-nav navbar-right">
    <li>
      <router-link to="/Login" class="a1 login" v-if="isLogin">登录</router-link>
    </li>
    <li>
      <router-link to="/Register" class="a1 register" v-if="isLogin">注册</router-link>
    </li>
    <li><a class="a1 nick_name" @click="toPersonal" v-text="nick_name" v-if="!isLogin"></a></li>
  </ul>
</template>
