      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="left-wrap wrap-l col-md-7">
            <img :src="item.companyimg__name" class="company_img"/>
          </div>

          <div class="right-wrap wrap-r col-md-5">
            <div>
              <span class="com-name company_name" v-text="item.name"></span>
              ...
              <div>
                ...
                <span class="tag-name">
                                    保证金：<i class="bond" v-text="item.bond"></i>
                                </span>

                <span class="tag-name">
                                    口碑值：<i class="mouth-value"
                                           v-text="item.mouth_value"><!--口碑值-->{{item.mouth_value}}</i>
                                </span>
            ...
            <div class="service-num-bar clearfix">
              <div style="margin-right:60px;float:left;">
                <p class="num case_num" v-text="item.case_num">
                </p>
                <p class="lab">设计案例</p>
              ...
              <div style="margin-right:60px;float:left;">
                <p class="num work_site_num" v-text="item.work_site_num">
                </p>
                <p class="lab">装修工地</p>
              </div>

              <div style="float:left;">
                <p class="num favorable_rate" v-text="item.favorable_rate">
                </p>
                <p class="lab">好评率</p>
              </div>
            </div>
            ...
            <div class="com-address-bx">
              <p class="address shopTreasure" v-text="'江苏省苏州市'+item.address"></p>
...
<script>
  ...
  export default {
    ...
    data: function () {
      return {
        id:this.$route.query && this.$route.query.company_id,
        collectType_id:3,
        item: {},
