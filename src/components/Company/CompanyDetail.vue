<template>
    <div class="contain">
        ...
        <!--公司基本信息--begin-->
        <company-base @myevent="changeShow_Apply"></company-base>
        <!--公司基本信息--end-->
        ...
        <!--预约模态框-begin-->
        <company-apply v-if="show_Apply" @myevent="changeShow_Apply"></company-apply>
        <!--预约模态框-end-->
