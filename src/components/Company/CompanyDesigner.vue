<template>
    ...
    <div class="main-content">
        <div class="module-cont">
            ...
            <div class="title-bar">
                <span class="cont-title">设计团队</span>
                <router-link :to="{ path:'/DesignerList', query:{company_id:company_id}}"
                             class="check-all designer_list">全部>
                </router-link>

                <!--<a href="#" class="check-all designer_list">全部></a>-->
            </div>

            <div class="container-fluid portrait">

                <div class="row portrait-cont">

                    <designer-item v-for="(item,index) in designer_info" :key="index" :item="item"></designer-item>
...
<script>
    ...
    export default {
        name: "CompanyDesigner",

        components: {
            'designer-item': DesignerItem,
        ...
        data: function () {
            return {
                ...
                designer_info: [
                    ...
                    //     des:'周琦',
                    //     case_number:'310',
                    //     des_icon:'../../../static/image/designer10.jpg'
                    // },
                    // {
                    //     des_id:'1',
                    //     des:'周琦',
        ...
        mounted: function () {
            axios.get(this.Global.server_url + "designer/designerList/", {
                ...
                console.log('设计师列表');
                this.designer_info = response.data.content;
                console.log(this.designer_info);
