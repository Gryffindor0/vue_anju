<template>
    ...
    <div class="main-content">
        <div class="module-cont">
            ...
            <div class="title-bar">
                <span class="cont-title">设计案例</span>
                <router-link :to="{ path:'/CaseList', query:{company_id:company_id}}" class="check-all case_list">全部>
                </router-link>
                <!--<a href="#" class="check-all case_list">全部></a>-->
            </div>

            <div class="container-fluid case">

                <div class="row case-cont">
