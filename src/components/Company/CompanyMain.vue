    ...
    <div class="main">
        <div class="container-fluid">
            <div class="row">
                ...
                <!--主体左-->
                <company-main-left></company-main-left>

                <!--主体右-->
                <company-main-right></company-main-right>
...
<script>
    ...
    import CompanyMainLeft from './CompanyMainLeft'
    import CompanyMainRight from './CompanyMainRight'
