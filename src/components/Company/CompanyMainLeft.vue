<template>
    ...
    <div class="cont col-md-9">
        ...
        <!--设计师模块--begin-->
        <company-designer></company-designer>
        <!--设计师模块--end-->
        ...
        <div class="main-content">
            <div class="module-cont">
                ...
                <div class="title-bar">
                    <span class="cont-title">装修工地</span>
                    <a href="#" class="check-all" target="_blank">全部></a>
                </div>

                <div class="container-fluid">

                    <div class="case-a row">
                        <div class="card-bx col-xs-4 col-sm-4 col-md-4">
                            <a href="">
                                <div class="img-ct">
                                    <img src="../../assets/work_site.jpg"/>
                                    <!--<img src="../image/work_site.jpg"/>-->
...
<script>
    ...
    import CompanyCase from './CompanyCase'
    import CompanyDesigner from './CompanyDesigner'

    export default {
        name: "CompanyMainLeft",

        components: {
            'company-case': CompanyCase,
            'company-designer': CompanyDesigner,
        },
