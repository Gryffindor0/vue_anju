  ...
  <div class="personal_diary center_right">
    <div class="collection">
      <div class="diary_modal">
        ...
        <div class="diary_content" v-show="showDiary">
          <!--日记列表--begin-->
          <div class="diary_list" v-for="di in diaryInfo">
            ...
            <div class="diary_title">
              ...
              <div class="time">
                <p v-text="'创建时间：'+di.public_date"></p>
                <p>更新时间：</p>
              </div>
        ...
        <div class="no_diary" v-show="!showDiary">

          <img src="../../assets/rabbit.png" alt="">
          <div>
            <span>您还没有写过任何日记</span>
            <a href="#" class="btn_instant">马上去写装修日记</a>
          </div>
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        diaryInfo: [
          {
            "id": "1", "diary_title": "日记一", "public_date": "3.20", "area": "210", "style": "欧式",
